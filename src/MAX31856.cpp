...
// set averaging mode
void MAX31856::setAvgSel(avgsel_t val)
{
...
void MAX31856::setTcType(tctype_t val)
{
...
void MAX31856::setLTHFT(int16_t val)
{
    regs.LTHFTH = val >> 8;
    regs.LTHFTL = val & 0xff;
}

void MAX31856::setLTLFT(int16_t val)
{
    regs.LTLFTH = val >> 8;
...
void MAX31856::setCJT(int16_t val)
{
    val <<= 2;
    regs.CJTH = val >> 8;
    regs.CJTL = val & 0xff;
